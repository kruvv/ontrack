<template>
  <div class="flex w-full gap-2">
    <BaseButton :type="BUTTON_TYPE_DANGER" :disabled="!timelineItem.activitySeconds"
    ...
    <BaseButton v-if="timelineItemTimer && timelineItem.hour === now.getHours()" :type="BUTTON_TYPE_WARNING"
      @click="stopTimelineItemTimer(timelineItem)">
      <BaseIcon :name="ICON_PAUSE" />
    </BaseButton>
    <BaseButton v-else :type="BUTTON_TYPE_SUCCESS" :disabled="timelineItem.hour !== now.getHours()"
